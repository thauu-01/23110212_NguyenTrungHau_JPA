...
public class HomeServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        dao = new CategoryDAO();
        if (dao == null) {
            throw new ServletException("Không thể khởi tạo CategoryDAO");
        }
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            // Xác định vai trò và lấy danh sách categories phù hợp
            ...
            // Đặt danh sách categories và chuyển tiếp đến JSP
