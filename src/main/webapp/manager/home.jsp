                    ...
                    <tbody>
                        <c:forEach var="cat" items="${categories}">
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/category/view?id=${cat.cateId}" class="btn btn-sm btn-info">Xem</a>
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/category/create">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="icons" name="icons" required>
                                        <option value="icon1.jpg">icon1.jpg</option>
                                        <option value="icon2.jpg">icon2.jpg</option>
                                    </select>
                                    <small class="form-text text-muted">
                                        Ảnh nằm trong thư mục: <strong>/resources/images/</strong>
                                    </small>
                                </div>
                            </div>
